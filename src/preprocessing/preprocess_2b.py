...
workflow = create_featreg_preproc(name='preprocess_cardiac_filtered') #The default name is "featpreproc".
workflow.base_dir = '/home/gdholla1/workflow_folders'

templates = {'functional_runs_phys_filtered':'/home/gdholla1/data/bias_task/preprocessed/phys_filtering/cardiac_only/phys_correction/residuals/_subject_id_{subject_id}/_get_residuals*/run*_unwarped_maths.nii.gz'}
...
workflow.connect(selector, 'functional_runs_phys_filtered', slice_corrector, 'in_file' )
workflow.connect(slice_corrector, 'slice_time_corrected_file', workflow.get_node('inputspec'), 'func' )
...
ds.inputs.base_directory = '/home/gdholla1/data/bias_task/preprocessed_cardiac/feat_preprocess/'
