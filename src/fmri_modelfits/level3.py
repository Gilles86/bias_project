...
selector.iterables = [('mask', ['STh_L_A', 'STh_L_B', 'STh_L_C', 'STh_R_A', 'STh_R_B', 'STh_R_C'][:2]), ('contrast', np.arange(17)[:1])]
...
fixedfx_flow.connect(selector, 'mask', smoothestimate, 'mask_file')
...
fixedfx_flow.connect(get_volume, ('out_stat', pickone), grf_cluster, 'volume')
