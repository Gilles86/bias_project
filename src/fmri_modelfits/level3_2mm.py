...
fixedfx_flow = create_fixed_effects_flow('level3_2mm')
...
#selector.iterables = [('mask', ['STh_L_A', 'STh_L_B', 'STh_L_C', 'STh_R_A', 'STh_R_B', 'STh_R_C', 'STh_L', 'STh_R']), ('contrast', [9])]
#selector.iterables = [('mask', ['STh_L', 'STh_R']), ('contrast', [9])]
...
cope_transformer.inputs.reference_image = fsl.Info.standard_image('MNI152_T1_2mm.nii.gz')
...
ds.inputs.base_directory = '/home/gdholla1/projects/bias/data/derivatives/glm_fits_level3.2mm/'
...
grf_cluster.inputs.volume = 228453
