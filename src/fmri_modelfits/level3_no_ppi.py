...
#selector.iterables = [('model', ['model0', 'model1a', 'model1b', 'model1c', 'model2'][:]), ('contrast', np.arange(8)), ('shift', [-1.5]), ('fwhm', [8.0])]
selector.iterables = [('model', ['model0', 'model1a', 'model1b', 'model1c'][:]), ('contrast', np.arange(4)), ('shift', [-1.5]), ('fwhm', [8.0])]
#selector.iterables = [('model', ['model3', 'model4'][:]), ('contrast', np.arange(2)), ('shift', [-1.5]), ('fwhm', [8.0])]
#for id in ['05', '10', '15']:
    #subject_ids.pop(subject_ids.index(id))
